                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="prices.php">Tarifas</a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="shop.php" id="navbarDropdownpro"
                        ...
                        <div class="dropdown cart">
                            <a class="dropdown-toggle" href="wishlist.php" id="navbarDropdown3" role="button"
